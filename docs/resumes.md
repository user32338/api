...
Работодатель может просматривать резюме только, если у компании есть топик на это резюме для активной вакансии.
...
Работодатель может скачать резюме соискателя только, если у компании есть топик на это резюме для активной вакансии
(без купленного доступа к базе резюме в файлах буду отсутствовать контакты). 
